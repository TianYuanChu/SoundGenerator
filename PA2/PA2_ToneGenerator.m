...
@implementation PA2_ToneGenerator
...
- (void)createToneUnit
{
    ...
    input.inputProcRefCon = CFBridgingRetain(self);
...

{
    ...
    PA2_ToneGenerator *toneGen = (__bridge PA2_ToneGenerator *)inRefCon;
...
{
    PA2_ToneGenerator *toneGen = (__bridge PA2_ToneGenerator *)inClientData;
    [toneGen stop];
}